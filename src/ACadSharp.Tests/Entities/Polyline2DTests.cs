...
namespace ACadSharp.Tests.Entities
{
	public class Polyline2DTests : CommonPolylineTests<Polyline2D, Vertex2D>
	{
		...
		{
			//AutoCAD's PLINE with a width of 150 measures 75 to each side of the centre line, and
			//its extents say so; the old-style POLYLINE carries the width on the vertexes rather
			//than in a single field, so both routes have to add it.
